  ...
  return (
    <>
      ...
      <div className="flex justify-around w-2/3 mx-auto my-5 text-red">
        ...
        <a
          href="https://www.linkedin.com/in/sunny-anand-9aa906105"
          target="_blank"
        >
      ...
      >
        ...
        <div className="flex items-center justify-center my-2">
          ...
          <span> letsunnybe99@gmail.com </span>
        </div>
        <div className="flex items-center justify-center my-2">
          <AiOutlinePhone className="mr-2" /> +91-9458705449
        </div>
      </div>

      <button
        className="w-10/12 px-5 py-2 text-white bg-black rounded-full cursor-pointer bg-gradient-to-r from-green to-blue-500 hover:scale-105 focus:outline-none"
